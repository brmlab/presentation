...
\item místo pro události (organizace pravidelných setkání)
\end{itemize}
}
...
\item 71! v Německu, 15 v Nizozemí, 10 ve Francii a Švýcarsku, 5 v Rakousku
\item Metalab Vídeň
\item HSPBP Budapešť
...
\item infrastruktura
  ...
  \item IRC: \#brmlab @ irc.freenode.net
  \item twitter.com/brmlab, facebook.com/brmlab
  \end{itemize}
\item prostory
  \begin{itemize}
  \item Kamenická 13 (wip)
  \end{itemize}
\item sponzori
\end{itemize}
}
