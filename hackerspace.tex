...
\item otevřená vysoko kreativní komunita
...
\item základní infrastruktura pro členy - síťové připojení, projektory, 3D tiskárny, unikátní hardware a software
\end{itemize}
}
...
\item občanské sdružení na demokratické báze
\end{itemize}
}
...
\item elektronika
\item augmentovaná realita, virtuální realita
...
\item více než 150 m$^{2}$ v Bratislavě
